...
class MistralAPI:
    ...
    def is_health_related(self, question):
        ...
        health_keywords = [
            'болит', 'боль', 'здоров', 'врач', 'болезнь', 'симптом', 'лечение',
            'медицин', 'таблетк', 'прививк', 'аллерг', 'давлен', 'температур',
            'кашель', 'горло', 'голов', 'живот', 'сердц', 'легк', 'печень',
            'почк', 'иммунит', 'вирус', 'бактери', 'анализ', 'диагноз', 'больн',
            'тошнит', 'рвота', 'понос', 'запор', 'сосуд', 'кров', 'давлен',
            'пульс', 'дыхание', 'сон', 'усталост', 'стресс', 'депресс', 'тревог',
            'вес', 'диет', 'питание', 'спорт', 'физкультур', 'зарядк', 'упражнен',
            'витамин', 'минерал', 'протеин', 'калори', 'ожирен', 'похуден',
            'кож', 'волос', 'ногт', 'зуб', 'глаз', 'ух', 'нос', 'гормон',
            'щитовид', 'диабет', 'инсулин', 'холестерин', 'артери', 'вен',
            'сустав', 'кост', 'мышц', 'спин', 'поясниц', 'шея', 'плеч'
        ]
    ...
    async def generate_response(self, question):
        ...
        Если вопрос не связан со здоровьем, ответь: "Я специализируюсь только на вопросах здоровья. Пожалуйста, задайте вопрос о здоровом образе жизни, симптомах или общих медицинских темах." (Больше ничего отвечать нельзя!!!!)
        ...
        Ответ: "Я специализируюсь на вопросах здоровья. Задайте, пожалуйста, вопрос о здоровом образе жизни или общих медицинских темах." (Больше ничего отвечать нельзя!!!!)
